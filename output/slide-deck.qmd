...
![](../www/verion-control-systems.png){fig-align="center"}
...
![](../www/git-collaboration.png){fig-align="center" height="100%"}
...
::: aside
Taken from [Office
Timeline](https://www.officetimeline.com/blog/nobel-prize-timeline)
:::
...
::: aside
Taken from [Daniel Korn](https://danielkorn.io/post/git-restore/)
:::
...
::: aside
Taken from [XKCD](https://xkcd.com/242/)
:::
...
which I would call transparency.
:::
...
::: aside
Taken from [LOLPics.com](https://lolpics.com/)
:::
...
```{r}
tags$iframe(src = "../www/sample_wordfile.txt", width = "100%", height = 550)
```
:::
...
```{r}
library(htmltools)
tags$iframe(src = "../www/sample_textfile.txt", width = "100%", height = 520)
```
:::
:::
...
you can open one in a notepad application and see it by yourselves.
...
![](../www/commit-changes-example.png){fig-align="center"}
...
::: columns
::: column
![](../www/rtf-file.png){fig-align="center"}
:::

::: column
![](../www/commit-changes-RTF.png){fig-align="center"}
:::
:::
...
![](../www/oversharing.png){fig-align="center"}
...
![](../www/meaningful_message.png){fig-align="center"}
...
![](../www/git-fire.jpg){fig-align="center"}
...
![](../www/merge-conflict.png){fig-align="center"}
...
![](../www/conflicts-headache.jpg){fig-align="center"}
...
![](../www/marshmallow.jpg){fig-align="center"}
...
![](../www/flowchart.png){fig-align="center"}
