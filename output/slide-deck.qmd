...
-   **Thor/Sif:** [First Steps in Learning the Use of Git & GitHub in
...
-   **Odin/Frigg:** Version control Workshop by Daniel and Emma (stay tuned!)

-   **Borr/Bestla:** [Building reproducible analytical pipelines with
    R](https://raps-with-r.dev/) by [Bruno
    Rodrigues](https://www.brodrigues.co/)
