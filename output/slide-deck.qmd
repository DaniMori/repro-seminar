...
when, and by whom, so we can gather more information about why the change was
made. This can help provide a lot of knowledge.

For example, seeing the timeline we may know what results are affected if an
analysis script has changed, and whether they need to be updated.
:::
